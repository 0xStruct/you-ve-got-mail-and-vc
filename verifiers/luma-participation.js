...
const vLumaParticipationRouter = express.Router();

vLumaParticipationRouter.get("/", (req, res) => {
    res.send("route: vLumaParticipationRouter");
});

vLumaParticipationRouter.post("/", async (req, res) => {
    ...
    while (verifyFailed === false) {
        ...
        var eventName = subject.split("Thanks for joining ")[1];
...
export default vLumaParticipationRouter;
